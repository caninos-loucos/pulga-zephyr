...
extern uint32_t scd30_init_time; // time at sample time configuration, for minimal time delay
/**
...
ssize_t write_co2_reference(struct bt_conn *conn, const struct bt_gatt_attr *attr, const void *buf, uint16_t len, uint16_t offset, uint8_t flags);
