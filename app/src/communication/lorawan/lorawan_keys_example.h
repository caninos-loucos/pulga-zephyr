...
#define LORAWAN_DEV_EUI {0xca, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x77} 
...
#define LORAWAN_APP_EUI {0xca, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x77}
// 128-bit Application Key, used to generate keys for encrypting 
// communication and generating session with OTAA
#define LORAWAN_APP_KEY {0xca, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x77}
// 128-bit Network Key, used to generate keys for signing Message 
// Integrity Codes during join network requests
#define LORAWAN_NET_KEY {0xca, 0xfe, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x77}
