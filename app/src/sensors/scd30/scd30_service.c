...
static void read_sensor_values()
{
    ...
    /**
     *  Note: Uncomment code bellow if you want the application to perform consecultive readings. 
     *  Otherwise, it will wait the interrupt routine in driver.
     */
...
static int init_sensor()
{
    ...
    // Registers desired callback into the scd30 driver api
